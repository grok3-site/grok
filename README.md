# Grok：如何访问和使用Grok3的教程，Grok3的访问入口在哪里~ 【2025-03-15 更新】           
...
2. **蓝鲸AI ([chat.lanjing.ai](https://chat.lanjing.ai/))**  
   **Grok3 中文站**，支持 Grok 3、GPT-4o、o1、o3 及 DeepSeek R1、Claude 3.7 sonnet 最先进的模型，无限使用~
...
6. **AI工具站 ([yixiaai.cn](https://yixiaai.cn/))**  
